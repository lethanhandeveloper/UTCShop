    ...
    return (
        ...
        <Row>
            ...
            >
                ...
                name="username"
                rules={[{ required: true, message: 'Please input allow file types' }]}
                >
                <Input />
                </Form.Item>
                ...
                >
                <Input type="number" addonAfter={selectAfter} defaultValue="mysite"/>
                </Form.Item>
                <Form.Item
                label="Location to save"
                name="password"
                rules={[{ required: true, message: 'Please input location to save' }]}
                >
                <Input />
                </Form.Item>
