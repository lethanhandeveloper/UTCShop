...
import { fetchProducts, clickAllCheckBox, clickSingleCheckBox, resetCheckBoxes, setPageIndex, setPageSize, toggleEditButtonStatus } from "../../redux/product/product.slice";
    ...
    return (
        <div
          ...
          >
            ...
            <Table 
              dataSource={data} columns={columns} scroll={{ x: 'max-content' }}
